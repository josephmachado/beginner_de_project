...
If you are interested in step by step explanation check out the post for this repo at  www.startdataengineering.com
...
4. [AWS Components](/pdf/aws-components-setup.pdf) to start the required services
...
Get the redshift cluster connection details and make sure you have a spectrum IAM role associated with it(as shown in [AWS Components](/pdf/aws-components-setup.pdf))
...
switch on your `DAG`, after running successfully and verifying the presence of data in redshift using
