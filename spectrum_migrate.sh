...
cat ./spectrum_tables/0001-create-stage-tables.sql | sed s/data-lake-bucket/$(terraform -chdir=./terraform output -raw redshift_dns_name)/ > ./spectrum_query_to_run/0001-create-stage-tables-run.sql
